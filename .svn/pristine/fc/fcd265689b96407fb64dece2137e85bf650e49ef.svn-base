<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Monitor.aspx.cs" Inherits="quickinfo_v2.Views.ChangeManagement.Monitor" %>
    ...
    <form role="form" class="form-horizontal form-groups-bordered" runat="server">
            ...
            <div class="panel-body">
                ...
                <div class="panel-body">
                                            ...
                                            <div style="width: 100%; ">                    
                                                 <div style="width: 15%;  float: left;">Release Comment</div>
                                                 <div style="width: 30%;  float: left;">
                                                     <telerik:RadTextBox ID="txtApproveComment" Runat="server" Skin="Default" Width="90%" TextMode="MultiLine">
                                                     </telerik:RadTextBox>
                                                     </div>   
                                                    <div style="width: 15%; height: 30px; float: left;">
                                                        UAT Release Comment</div>  
                                               <div style="width: 30%; height: 30px; float: left;">
                                                     <telerik:RadTextBox ID="txtUATComment" Runat="server" Skin="Default" Width="90%" TextMode="MultiLine">
                                                     </telerik:RadTextBox>
                                                     </div>   
                                                </div>
        ...
        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="multiPage" Width="100%" >
            <telerik:RadPageView ID="RadPageView1" runat="server" Height="320px">
                ...
                <div style="width: 95%; height: 40px;">
                    <div style="width: 15%; height: 30px; float: left;">Implement Comment</div>
                    <div style="width: 30%; height: 30px; float: left;">
                        <asp:Label ID="lblImplementComment" runat="server" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Height="23px" Width="99%"></asp:Label>
                   ...
                   <div style="width: 95%; height: 30px;">   </div>
                       ...
                       <telerik:RadGrid ID="RdGrdEvents" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Width="99%" AllowPaging="True" PageSize="5" OnNeedDataSource="RdGrdEvents_NeedDataSource">
                        ...
                        <HeaderContextMenu CssClass="GridContextMenu GridContextMenu_Default"></HeaderContextMenu>
                                ...
                                CssClass="btn btn-apps" Width="100px" Enabled="False" OnClick="BtnApprove_Click" />   
                                                     <asp:Button ID="BtnUATRelease" runat="server" Text="UAT Release"
                                CssClass="btn btn-apps" Width="100px" Enabled="False" OnClick="BtnUATRelease_Click" />             
                            <asp:Button ID="BtnUpdate" runat="server" Text="Release"
