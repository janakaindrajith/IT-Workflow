...
{
    public partial class LifePolicySearch : System.Web.UI.Page
    {
        ...
        {
            DtSearch = CRC.SelectDataCRCLife(txtPolicyNo.Text.Trim() == "" ? "-" : txtPolicyNo.Text, txtProposalNo.Text.Trim() == "" ? "-" : txtProposalNo.Text, txtInsuredName.Text.Trim() == "" ? "-" : txtInsuredName.Text, txtNIC.Text.Trim() == "" ? "-" : txtNIC.Text, txtContactNo.Text.Trim() == "" ? "-" : txtContactNo.Text);
        ...
        protected void grdJob_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[4].Text = "Policy Status";
                e.Row.Cells[5].Text = "Effective Date";
                e.Row.Cells[6].Text = "Expiry Date";
                e.Row.Cells[7].Text = "Branch";
                e.Row.Cells[8].Text = "Policy ID";
        ...
        {
            Response.Redirect("~/Views/CRC/LifePolicySearch.aspx");
        }
    }
}