                ...
                <div class="panel-body">
                                                 ...
                                                 <div style="width: 30%; height: 30px; float: left;">
                                                     ...
                                                     <div style="width: 15%; height: 30px; float: left;">
                                                         <asp:CheckBox ID="ChkCIAttatched" runat="server" Text="CI attatched" />
                                                      </div>
                                                 <div style="width: 15%; height: 30px; float: left;">
                                                     <asp:CheckBox ID="ChkSVN" runat="server" Text="SVN attatched" />
                                                     </div>   
                                                        <div style="width: 15%; height: 30px; float: left;">
                                                            <asp:CheckBox ID="ChkDeployment" runat="server" Text="Deployment Plan" />
                                                     </div>    
                                                </div>
                                            ...
                                            <div style="width: 100%; ">                    
                                                 ...
                                                 <div style="width: 30%;  float: left;">
                                                    ...
                                                    <div style="width: 15%; height: 30px; float: left;">
                                                        <asp:CheckBox ID="ChkCheckList" runat="server" Text="Checklist for Test" />
                                                     </div>  
                                               <div style="width: 30%; height: 30px; float: left;">
                                                     <asp:CheckBox ID="ChkPrerequisites" runat="server" Text="Prerequsites for Implementation" />
                                                     </div>   
                                                </div>
