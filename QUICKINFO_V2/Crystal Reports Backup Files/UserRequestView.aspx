                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5a">
                                 <telerik:RadButton ID="btnSearch1" runat="server" Skin="Office2007" Text="Search" Width="100px" OnClick="btnSearch1_Click">
                                                          </telerik:RadButton>
                                                          <telerik:RadButton ID="btnClear1" runat="server" Skin="Office2007" Text="Clear" Width="100px" OnClick="btnClear1_Click">
                                                          </telerik:RadButton>
                ...
                <div class="panel-body"">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5a">
                                                          ...
                                                          <telerik:RadButton ID="btnAddNew" runat="server" Skin="Office2007" Text="Insert" Width="100px" OnClick="btnAddNew_Click1">
                                                          </telerik:RadButton>
