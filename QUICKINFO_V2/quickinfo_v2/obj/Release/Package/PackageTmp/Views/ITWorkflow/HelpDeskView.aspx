        ...
        <div class="panel panel-default">
            ...
            <UpdatedControls>
                ...
                <div style="width: 100%; height: 40px;">
                    ...
                    <div style="width: 8%; height: 30px; float: left;">

                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="CmbJobType" ErrorMessage="Value required" ForeColor="Red" ValidationGroup="UP" InitialValue="--Select Job Type--"></asp:RequiredFieldValidator>
                ...
                <div style="width: 100%; height: 40px;">
                    ...
                    <div style="width: 8%; height: 30px; float: left;">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="CmbJobDecsription" ErrorMessage="Value required" ForeColor="Red" ValidationGroup="UP" InitialValue="--Select Job Description--"></asp:RequiredFieldValidator>
                ...
                <div style="width: 100%; height: 40px;">
                    ...
                    <div style="width: 15%; height: 30px; float: left;">Assign</div> <%--Reassign--%>
                    <div style="width: 30%; height: 30px; float: left;">
                        <telerik:RadComboBox ID="CmbReassgn" runat="server" Skin="Default" Width="90%" OnSelectedIndexChanged="CmbReassgn_SelectedIndexChanged">
                        </telerik:RadComboBox>
                    </div>
                </div>
                <div style="width: 100%; height: 40px;">
                ...
                <div style="width: 100%; height: 70px;">
                    ...
                    <div style="width: 8%; height: 30px; float: left;">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtRemarks1" ErrorMessage="Value required" ForeColor="Red" ValidationGroup="UP"></asp:RequiredFieldValidator>
                ...
                <div style="width: 100%; height: 40px;">
                    ...
                    <div style="width: 80%; height: 30px; float: left;">
                        ...
                        <asp:Button ID="BtnUpdate" runat="server" Text="Update" OnClick="BtnUpdate_Click"
                            CssClass="btn btn-apps" Width="100px" ValidationGroup="UP" />
