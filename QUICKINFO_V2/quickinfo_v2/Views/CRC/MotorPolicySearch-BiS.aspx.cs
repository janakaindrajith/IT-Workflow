...
{
    public partial class MotorPolicySearch_BiS : System.Web.UI.Page
    {
        ...
        {
            DtSearch = CRC.SelectDataCRCMotorBiS(txtPolicyNo.Text.Trim() == "" ? "-" : txtPolicyNo.Text, txtVehicleNo.Text.Trim() == "" ? "-" : txtVehicleNo.Text, txtProposalNo.Text.Trim() == "" ? "-" : txtProposalNo.Text, txtEngineNo.Text.Trim() == "" ? "-" : txtEngineNo.Text, txtChassiNo.Text.Trim() == "" ? "-" : txtChassiNo.Text, txtContactNo.Text.Trim() == "" ? "-" : txtContactNo.Text, txtInsuredName.Text.Trim() == "" ? "-" : txtInsuredName.Text);
        ...
        {
            Response.Redirect("~/Views/CRC/MotorPolicySearch-BiS.aspx");
        }
    }
}