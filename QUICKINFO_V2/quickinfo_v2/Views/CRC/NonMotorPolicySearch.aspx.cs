...
{
    public partial class NonMotorPolicySearch : System.Web.UI.Page
    {
        ...
        {
            DtSearch = CRC.SelectDataCRCNonMotor(txtPolicyNo.Text.Trim() == "" ? "-" : txtPolicyNo.Text, txtProposalNo.Text.Trim() == "" ? "-" : txtProposalNo.Text, txtInsuredName.Text.Trim() == "" ? "-" : txtInsuredName.Text, txtNIC.Text.Trim() == "" ? "-" : txtNIC.Text);
        ...
        protected void grdJob_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[4].Text = "Effective Date";
                e.Row.Cells[5].Text = "Expiry Date";
                e.Row.Cells[6].Text = "Policy ID";
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[4].Text = e.Row.Cells[4].Text.Remove(10);
        ...
        {
            Response.Redirect("~/Views/CRC/NonMotorPolicySearch.aspx");
        }
    }
}