<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MototIntimationSearch.aspx.cs" Inherits="quickinfo_v2.Views.CRC.MototIntimationSearch" %>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">
                        Search Motor Intimation
                    </div>
                </div>

                <div class="panel-body">
                    <div class="form-group">
                        <label for="txtMOINo" class="col-sm-2 control-label">MOI No</label>
                        <div class="col-sm-5">
                            <asp:TextBox ID="txtMOINo" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
