...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form role="form" class="form-horizontal form-groups-bordered" runat="server" id="form1">
        ...
        <div class="panel panel-default">
             ...
             <%--CR-TAKEN--%>
            <div class="panel-heading" id="pnl_job_type_wise_cr" runat="server">
                <div class="panel-title">
                    Jobs Taken - CR
                </div>
            </div>
            <div class="panel-body" id="pnlBdy_job_type_wise_cr" runat="server">
                <div style="width: 100%;">
                    <style type="text/css">
                        .RadGrid_Default th.rgHeader {
            ...
            <%--SR-TAKEN--%>
            <div class="panel-heading" id="pnl_job_type_wise_sr" runat="server">
                <div class="panel-title">
                    Jobs Taken - SR
                </div>
            </div>
            <div class="panel-body" id="pnlBdy_job_type_wise_sr" runat="server">
                <div style="width: 100%;">
                    <style type="text/css">
                        .RadGrid_Default th.rgHeader {
                            background-image: none;
            ...
            <%--ER-Taken--%>
            <div class="panel-heading" id="pnl_job_type_wise_er" runat="server">
                <div class="panel-title">
                    Jobs Taken - ER
                </div>
            </div>
            <div class="panel-body" id="pnlBdy_job_type_wise_er" runat="server">
                ...
                <div style="width: 100%;">
                    ...
                    <telerik:RadGrid ID="grd_er_taken" OnItemCommand="grd_er_taken_ItemCommand" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" OnNeedDataSource="grd_er_taken_NeedDataSource" PageSize="5" Width="99%"  CssClass="table table-bordered datatable dataTable">
                        <MasterTableView>
                            <CommandItemSettings ExportToPdfText="Export to PDF" />
                            <RowIndicatorColumn FilterControlAltText="Filter RowIndicator column">
                                <HeaderStyle Width="20px" />
            ...
            <%--PENDING CLARIFICATION COMPLETE JOBS - ER--%>

            <div class="panel-heading" id="pnl_pendingClarificationPendingJobs_ER" runat="server">
                <div class="panel-title">
                    &nbsp;Pending Clarification Complete Jobs - ER
                </div>
            </div>
            <div class="panel-body" id="pnlBdy_pendingClarificationPendingJobs_ER" runat="server">

                <div style="width: 100%;">

                    <telerik:RadGrid ID="GrdPenClariCom_ER" runat="server" Width="99%" AllowPaging="True" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" OnNeedDataSource="GrdPenClariCom_ER_NeedDataSource" PageSize="5" OnItemCommand="GrdPenClariCom_ER_ItemCommand">
                        <MasterTableView>
                            <CommandItemSettings ExportToPdfText="Export to PDF" />
                            <RowIndicatorColumn FilterControlAltText="Filter RowIndicator column">
                                <HeaderStyle Width="20px" />
            ...
            <%--PENDING CLARIFICATION COMPLETE JOBS - SR--%>

            <div class="panel-heading" id="pnl_pendingClarificationPendingJobs_SR" runat="server">
                <div class="panel-title">
                    &nbsp;Pending Clarification Complete Jobs - SR
                </div>
            </div>
            <div class="panel-body" id="pnlBdy_pendingClarificationPendingJobs_SR" runat="server">

                <div style="width: 100%;">

                    <telerik:RadGrid ID="GrdPenClariCom_SR" runat="server" Width="99%" AllowPaging="True" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" OnNeedDataSource="GrdPenClariCom_SR_NeedDataSource" PageSize="5" OnItemCommand="GrdPenClariCom_SR_ItemCommand">
                        <MasterTableView>
                            <CommandItemSettings ExportToPdfText="Export to PDF" />
                            <RowIndicatorColumn FilterControlAltText="Filter RowIndicator column">
                                <HeaderStyle Width="20px" />
            ...
            <%--PENDING CLARIFICATION COMPLETE JOBS - CR--%>

            <div class="panel-heading" id="pnl_pendingClarificationPendingJobs_CR" runat="server">
                <div class="panel-title">
                    &nbsp;Pending Clarification Complete Jobs - CR
                </div>
            </div>
            <div class="panel-body" id="pnlBdy_pendingClarificationPendingJobs_CR" runat="server">

                <div style="width: 100%;">

                    <telerik:RadGrid ID="GrdPenClariCom_CR" runat="server" Width="99%" AllowPaging="True" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" OnNeedDataSource="GrdPenClariCom_CR_NeedDataSource" PageSize="5" OnItemCommand="GrdPenClariCom_CR_ItemCommand">
                        <MasterTableView>
                            <CommandItemSettings ExportToPdfText="Export to PDF" />
                            <RowIndicatorColumn FilterControlAltText="Filter RowIndicator column">
                                <HeaderStyle Width="20px" />
